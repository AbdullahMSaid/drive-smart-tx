        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
              ...
              <li id="service-area" className="flex items-start gap-2 scroll-mt-32"><MapPin className="h-4 w-4 mt-0.5 text-gold shrink-0" /><span>Dallas, TX 75235 · Serving the DFW area</span></li>
